...
class ITileDirective(Interface):
    ...
    title = MessageID(
            title=u"Title",
            description=u"User friendly title, used in configuring the tile",
            required=False
        )
    ...
    add_permission = Permission(
            ...
            description=u"Name of the permission required to add this tile",
            required=False,
        )
...
def tile(_context, name, title=None, description=None, add_permission=None,
         edit_permission=None, delete_permission=None, schema=None, for_=None,
         layer=None, class_=None, template=None, permission=None):
